...
//이미지 파일 다운로드
@Controller
public class contImaDownController {
	// 업로드된 폴더와 위치가 같아야 한다.
	private static final String ARTICLE_IMAGE_REPO = "C:\\data\\team\\pick\\src\\main\\webapp\\resources\\images";
	
	// 이미지 파일 다운로드
	@RequestMapping(value="/cTIdown")
	protected void download2(@RequestParam("image") String imgfn,
							HttpServletResponse response) throws Exception{
		OutputStream out = response.getOutputStream();
		String downFile = ARTICLE_IMAGE_REPO + "\\" + "contentImage" + "\\" + imgfn;
